...
export default function Navbar() {
  ...
  return (
    <nav className="bg-gray-600 fixed">
      <div className="w-screen px-4 md:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0 text-white">Camilo García</div>
          </div>
...
<nav className="bg-gray-800">
      <div className="w-screen mx-auto px-2 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 bg-blue-400">
